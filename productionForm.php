...
?>
    <script>
        ...
        function submitAnimation()
        {
            ...
            if(error)
            {
                alert("All Fields must be completed: " + error);
                return;
            }
                ...
                <div class="box-header">
                 ...
                 <div class="box-body">
                        ...
                        <div class="table-responsive" id="table_div">
                            ...
                            <table class="table table-bordered table-striped dataTable" id="assessment_table" name="assessment_table">
                                ...
                                <tr>
                                    ...
                                    <th><label for="comments0">Comments0</label></th>
                                </tr>
                                </thead>
                                <tbody>
                                <tr>
                                    ...
                                    <td class=" "><textarea rows="1" cols="50" class="form-control" type="text"   id="comments0"         name="comments0"></textarea></td>
                                </tr>
                                </tbody>
                            </table>
                        </div>
                    <div class="box-footer">
                        ...
                        <button type="button" class="btn btn-info" onclick="clearFields();">Clear Fields</button>
                        <br />
                        <br />
                        <br />
